        ...
        {orderData && !orderData.success ? (
          ...
          <div>
            ...
            <table className="w-full border">
              ...
              <tbody>
                {orderData &&
                  orderData?.data?.products?.map((products) => (
                    <tr key={products.variantId._id} className="md:table-row block border-b">
                      <td className="p-4">
                        <div className="flex items-center gap-5">
                          ...
                          <div>
                            <h4 className="text-lg line-clamp-1">
                              ...
                              <p>Color: {products?.variantId?.color}</p>
                              <p>Size: {products?.variantId?.size}</p>
                            </h4>
                          </div>
                        </div>
                      </td>
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 gap-10 border md:divide-x mt-10">
              <div className="p-5">
              ...
              <div className="p-5 bg-gray-50">
                <h4 className="text-lg font-semibold mb-5">Amount Summary</h4>
                <div>
                  <table className="w-full">
                    <tbody>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td className="text-end py-2">{orderData?.data?.discount.toLocaleString("en-IN", {
                          style: "currency",
                          currency: "INR",
                        })}</td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td className="text-end py-2">{orderData?.data?.status}</td>
                      </tr>
                      <tr>
                        <td className="font-medium py-2">Total</td>
                        <td className="text-end py-2">{orderData?.data?.totalAmount.toLocaleString("en-IN", {
                          style: "currency",
                          currency: "INR",
                        })}</td>
                      </tr>
