...
const ModalMediaBlock = ({
  ...
  isMultiple,
    ...
    const handleCheck = ()=>{
        ...
        if(isMultiple){
            // selected multiple media
            if(isSelected){
                // remove selectedMedia from arry
  ...
  return (
    ...
    >
      ...
      <div className="size-full relative">
        <Image src={media.secure_url} alt={media.alt || ''} width={300} height={300} className="object-cover md:h-[150px] h-[100px]"/>
      </div>
    </label>
  );
};
