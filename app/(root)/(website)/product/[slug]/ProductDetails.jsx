    ...
    <div className="lg:px-32 px-4">
      ...
      <div className="md:flex justify-between items-start lg:gap-10 gap-5 mb-20">
        <div className="md:w-1/2 xl:flex xl:justify-center xl:gap-5 md:sticky md:top-0">
          ...
          <div className="flex xl:flex-col items-center xl:gap-5 gap-3 xl:w-36 overflow-auto xl:pb-0 pb-2 max-h-[650px]">
        ...
        <div className="md:w-1/2 md:mt-0 mt-5">
          ...
          {/* <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-xl font-semibold">{variant.mrp && new Intl.Number('en-IN',{style: 'currency', currency: 'INR'}).format(number(variant.mrp))}</span>
            </div> */}
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="bg-red-500 rounded-2xl px-3 py-1 text-white font-semibold text-xs ms-5">
              -{variant?.discountPercentages}%
            </span>
          </div>
          ...
          <div className="mt-5">
            ...
            <div className="flex items-center h-10 border w-fit rounded-full">
              <button
                type="button"
                className="h-full w-10 justify-center items-center px-3"
