  ...
  return (
    <div className="grid lg:grid-cols-4 sm:grid-cols-2 sm:gap-10 gap-5">
      <Link href={ADMIN_CATEGORY_SHOW}>
        <div className="flex items-center justify-between p-3 rounded-lg border shadow border-l-4 border-l-green-500 bg-white dark:bg-card dark:border-green-800 dark:border-l-green-40">
          <div>
      ...
      <Link href={ADMIN_PRODUCT_SHOW}>
        <div className="flex items-center justify-between p-3 rounded-lg border shadow border-l-4 border-l-blue-500 bg-white dark:bg-card dark:border-gray-800 dark:border-l-blue-40">
          <div>
      ...
      <Link href={ADMIN_CUSTOMER_SHOW}>
        <div className="flex items-center justify-between p-3 rounded-lg border shadow border-l-4 border-l-yellow-500 bg-white dark:bg-card dark:border-gray-800 dark:border-l-yellow-400">
          <div>
